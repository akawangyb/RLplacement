...
class MADDPG:
    def __init__(self, env, device, actor_lr, critic_lr, hidden_dim,
        ...
        for i in range(env.placing_agents_number + env.routing_agents_number):
            self.agents.append(
    ...
    def update(self, idx, batch):
        ...
        cur_agent_action = cur_agent.take_action(state,explore=True)  # 这个动作需要可导

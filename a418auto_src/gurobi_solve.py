...
for t in time_slots:
    ...
    for r in slot_requests[t]:
        ...
        for k in x[req_id]:
            ...
            if x[req_id][k].X == 1:
                if k == 'cloud':
                    current_allocation[t][server_num] = 1
                break
...
# 使用示例
save_to_yaml(deployment_results, allocation_results, 'deployment_results.yaml')

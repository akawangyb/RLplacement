...
path=r'../log_res/ablation/multi_exp_critic/save_solution_v2_env-20250222-012730/output_info.log'
path = [r'../log_res/ablation/multi_exp_critic/save_solution_v2_env-20250222-012730/output_info.log',
...
draw_imitation_fig1(ax1, title[0], path[0], annotate_text=r'$\times10^{6}$', critic=True)
...
path = r'../log_res/ablation/multi_exp_critic/imitation_learning_env-20250222-013246/output_info.log'
draw_sub_fig(ax3, title='$\mathrm{(c)Step=0}$的后续训练收益', file_path=path, i=index)
index += 1
# 右边上面的第二个图
ax4 = fig.add_subplot(gs[1, 1])
path = r'../log_res/ablation/multi_exp_critic/imitation_learning_env-20250222-015102/output_info.log'
draw_sub_fig(ax4, title='$\mathrm{(d)Step=36}$的后续训练收益', file_path=path, i=index)
index += 1
# 右边下面的第一个图
ax5 = fig.add_subplot(gs[2, 1])
path = r'../log_res/ablation/multi_exp_critic/imitation_learning_env-20250222-020746/output_info.log'
draw_sub_fig(ax5, title='$\mathrm{(e)Step=47}$的后续训练收益', file_path=path, i=index)
index += 1
# 右边下面的第二个图
ax6 = fig.add_subplot(gs[3, 1])
path = r'../log_res/ablation/multi_exp_critic/imitation_learning_env-20250222-022458/output_info.log'

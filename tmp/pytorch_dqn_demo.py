...
class PrioritizedReplayMemory:
    ...
    def sample(self, batch_size):
        if len(self.memory) == self.capacity:
            ...
            priorities = np.array(self.priorities + [0]*(self.capacity - len(self.memory)))
    ...
    def update_priorities(self, indices, batch_priorities):
        for idx, priority_val in zip(indices, batch_priorities):

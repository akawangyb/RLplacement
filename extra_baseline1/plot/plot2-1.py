...
exp_list = ['5exp_1', '5exp_2', '5exp_3']

file_paths1 = find_log_folders(r'../log_res/5exp_1')
file_paths2 = find_log_folders(r'../log_res/5exp_2')
file_paths3 = find_log_folders(r'../log_res/5exp_3')

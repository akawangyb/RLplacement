...
# path=r'../log_res/ablation/3exp1_actor/experiment_epochs_env-20240811-132038/output_info.log'
path = [r'../log_res/ablation/3exp1_actor/experiment_epochs_env-20240811-132038/output_info.log',
        r'../log_res/ablation/3exp1_actor']
...
path = r'../log_res/ablation/3exp1_actor/imitation_learning_env-20250218-162144/output_info.log'
draw_sub_fig(ax3, title='$\mathrm{(c)}$ $\mathrm{Step=62}$的后续训练收益', file_path=path, i=index)
index += 1
# 右边上面的第二个图
ax4 = fig.add_subplot(gs[1, 1])
path = r'../log_res/ablation/3exp1_actor/imitation_learning_env-20250218-164333/output_info.log'
draw_sub_fig(ax4, title='$\mathrm{(d)}$ $\mathrm{Step=66}$的后续训练收益', file_path=path, i=index)
index += 1
# 右边下面的第一个图
ax5 = fig.add_subplot(gs[2, 1])
path = r'../log_res/ablation/3exp1_actor/imitation_learning_env-20250218-170338/output_info.log'
draw_sub_fig(ax5, title='$\mathrm{(e)}$ $\mathrm{Step=80}$的后续训练收益', file_path=path, i=index)
index += 1
# 右边下面的第二个图
ax6 = fig.add_subplot(gs[3, 1])
path = r'../log_res/ablation/3exp1_actor/imitation_learning_env-20250218-170635/output_info.log'
draw_sub_fig(ax6, title='$\mathrm{(f)}$ $\mathrm{Step=92}$的后续训练收益', file_path=path, i=index)

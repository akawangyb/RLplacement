...
def draw_imitation_fig1(ax, title, file_path=r'2exp_3',
    ...
    axins = zoomed_inset_axes(ax, zoom=3, loc='center right')
...
# path=r'../log_res/ablation/multi_exp_critic/critic_loss.log'
path = [r'../log_res/ablation/multi_exp_critic/critic_loss.log',
        r'../log_res/ablation/multi_exp_critic/']
...
file_path0 = r'../log_res/ablation/3exp2_critic/critic_loss.log'
draw_imitation_fig1(ax1, title[0], path[0], annotate_text=r'$\times10^{11}$', critic=True, file_path0=file_path0)
...
path = r'../log_res/ablation/multi_exp_critic/imitation_learning_v2_env-20250222-165901/output_info.log'
draw_sub_fig(ax3, title='$\mathrm{(c)}$ $\mathrm{Step=0}$的后续训练收益', file_path=path, i=index)
index += 1
# 右边上面的第二个图
ax4 = fig.add_subplot(gs[1, 1])
path = r'../log_res/ablation/multi_exp_critic/imitation_learning_v2_env-20250222-171657/output_info.log'
draw_sub_fig(ax4, title='$\mathrm{(d)}$ $\mathrm{Step=30}$的后续训练收益', file_path=path, i=index)
index += 1
# 右边下面的第一个图
ax5 = fig.add_subplot(gs[2, 1])
path = r'../log_res/ablation/multi_exp_critic/imitation_learning_v2_env-20250222-173357/output_info.log'
draw_sub_fig(ax5, title='$\mathrm{(e)}$ $\mathrm{Step=60}$的后续训练收益', file_path=path, i=index)
index += 1
# 右边下面的第二个图
ax6 = fig.add_subplot(gs[3, 1])
path = r'../log_res/ablation/multi_exp_critic/imitation_learning_v2_env-20250222-174950/output_info.log'

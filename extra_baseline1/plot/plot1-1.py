...
exp1_title_list = [
    '$(\mathrm{a})$ 容器数量设置为$30$的训练奖励对比',
    '$(\mathrm{b})$ 容器数量设置为$50$的训练奖励对比',
    '$(\mathrm{c})$ 容器数量设置为$70$的训练奖励对比',
    '$(\mathrm{d})$ 容器数量设置为$30$的总时延对比',
    '$(\mathrm{e})$ 容器数量设置为$50$的总时延对比',
    '$(\mathrm{f})$ 容器数量设置为$70$的总时延对比',
]

...
path = r'../log_res/ablation2/6-3/actor/experiment_epochs_env-20250301-213934/output_info.log'
path = [r'../log_res/ablation2/6-3/actor/experiment_epochs_env-20250301-213934/output_info.log',
        r'../log_res/ablation2/6-3/actor']
...
path = r'../log_res/ablation2/6-3/actor/imitation_learning_env-000-20250301-210049/output_info.log'
...
path = r'../log_res/ablation2/6-3/actor/imitation_learning_env-055-20250302-135430/output_info.log'
draw_sub_fig(ax3, title='$\mathrm{(d)}$ $\mathrm{Step=55}$的后续训练收益',
             annotate_text=r'$\times 10^5$', file_path=path, i=index)
index += 1

# 右边上面的第一个图
ax3 = fig.add_subplot(gs[index, 1])
path = r'../log_res/ablation2/6-3/actor/imitation_learning_env-20250304-001223/output_info.log'
draw_sub_fig(ax3, title='$\mathrm{(e)}$ $\mathrm{Step=68}$的后续训练收益',
             annotate_text=r'$\times 10^5$', file_path=path, i=index)
index += 1
# 右边上面的第二个图
ax4 = fig.add_subplot(gs[index, 1])
path = r'../log_res/ablation2/6-3/actor/imitation_learning_env-20250304-003529/output_info.log'
draw_sub_fig(ax4, title='$\mathrm{(f)}$ $\mathrm{Step=77}$的后续训练收益',
             annotate_text=r'$\times 10^5$', file_path=path, i=index)
index += 1
# 右边下面的第一个图

...
def draw_imitation_fig1(ax, title, file_path=r'2exp_3',
    ...
    ax.legend(prop=kai_font_prop, loc='center right', ncol=1)
...
path = [r'../log_res/ablation/multi_exp_actor/save_solution_v2_env-20250222-010308/output_info.log',
        r'../log_res/ablation/multi_exp_actor/']
...
file_path0 = r'../log_res/ablation/3exp2_actor/experiment_epochs_env-20250220-194845/output_info.log'
...
path = r'../log_res/ablation/multi_exp_actor/imitation_learning_env-20250222-122901/output_info.log'
draw_sub_fig(ax3, title='$\mathrm{(c)}$ $\mathrm{Step=0}$的后续训练收益', file_path=path, i=index)
index += 1
# 右边上面的第二个图
ax4 = fig.add_subplot(gs[1, 1])
path = r'../log_res/ablation/multi_exp_actor/imitation_learning_env-20250222-124714/output_info.log'
draw_sub_fig(ax4, title='$\mathrm{(d)}$ $\mathrm{Step=36}$的后续训练收益', file_path=path, i=index)
index += 1
# 右边下面的第一个图
ax5 = fig.add_subplot(gs[2, 1])
path = r'../log_res/ablation/multi_exp_actor/imitation_learning_env-20250222-130542/output_info.log'
draw_sub_fig(ax5, title='$\mathrm{(e)}$ $\mathrm{Step=47}$的后续训练收益', file_path=path, i=index)
index += 1
# 右边下面的第二个图
ax6 = fig.add_subplot(gs[3, 1])
path = r'../log_res/ablation/multi_exp_actor/imitation_learning_env-20250222-132615/output_info.log'
draw_sub_fig(ax6, title='$\mathrm{(f)}$ $\mathrm{Step=60}$的后续训练收益', file_path=path, i=index)

...
from save_solution_v2 import merge_transition
...
def get_transition_from_file(tail='_expert_solution.pkl1'):
    transition_dict = {'states': [], 'actions': [], 'next_states': [], 'rewards': [], 'dones': []}
    expert_file_path = os.path.join('data', config.data_dir + tail)
...
transition_dict1=get_transition_from_file(tail='_expert_solution.pkl1')
transition_dict2=get_transition_from_file(tail='_expert_solution.pkl2')

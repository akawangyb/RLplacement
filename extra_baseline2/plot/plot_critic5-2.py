...
path = [r'../log_res/ablation2/5-2/critic/critic.loss',
        r'../log_res/ablation2/5-2/critic']
...
path = r'../log_res/ablation2/5-2/critic/imitation_learning_env-000-20250308-114454/output_info.log'
draw_sub_fig(ax3, title='$\mathrm{(c)}$ $\mathrm{Step=0}$的后续训练收益', file_path=path, i=index)
index += 1
# 右边上面的第二个图
ax4 = fig.add_subplot(gs[1, 1])
path = r'../log_res/ablation2/5-2/critic/imitation_learning_env-024_20250308-131326/output_info.log'
draw_sub_fig(ax4, title='$\mathrm{(d)}$ $\mathrm{Step=10}$的后续训练收益', file_path=path, i=index)
index += 1
# 右边下面的第一个图
ax5 = fig.add_subplot(gs[2, 1])
path = r'../log_res/ablation2/5-2/critic/imitation_learning_env-050_20250308-134250/output_info.log'
draw_sub_fig(ax5, title='$\mathrm{(e)}$ $\mathrm{Step=50}$的后续训练收益', file_path=path, i=index)
index += 1
# 右边下面的第二个图
ax6 = fig.add_subplot(gs[3, 1])
path = r'../log_res/ablation2/5-2/critic/imitation_learning_env-150_20250308-144303/output_info.log'

...
title1_1 = ['$(\mathrm{a})$ 动作网络模仿学习的训练收益',
            '$(\mathrm{b})$ 不同学习步数的后续训练收益']

# path = r'../log_res/3exp_2/experiment_epochs_env-20250112-181657/output_info.log'
# path1_1 = [r'../log_res/3exp_1/experiment_epochs_env-20240811-132038/output_info.log',
#            r'../log_res/ablation/3exp_1_actor']

path = r'../log_res/ablation/3exp2_actor/experiment_epochs_env-20250220-194845/output_info.log'
path1_1 = [r'../log_res/ablation/3exp2_actor/experiment_epochs_env-20250220-194845/output_info.log',
           r'../log_res/ablation/3exp2_actor']

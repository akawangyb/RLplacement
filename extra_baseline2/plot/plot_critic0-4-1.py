...
path = [r'../log_res/ablation2/4-1/critic140/critic.loss',
        r'../log_res/ablation2/4-1/critic0']
...
path = r'../log_res/ablation2/4-1/critic0/imitation_learning_env-000-20250228-142728/output_info.log'
draw_sub_fig(ax3, title='$\mathrm{(c)}$ $\mathrm{Step=0}$的后续训练收益', file_path=path, i=index)
index += 1
# 右边上面的第二个图
ax4 = fig.add_subplot(gs[1, 1])
path = r'../log_res/ablation2/4-1/critic0/imitation_learning_env-024-20250307-211609/output_info.log'
draw_sub_fig(ax4, title='$\mathrm{(d)}$ $\mathrm{Step=24}$的后续训练收益', file_path=path, i=index)
index += 1
# 右边下面的第一个图
ax5 = fig.add_subplot(gs[2, 1])
path = r'../log_res/ablation2/4-1/critic0/imitation_learning_env-050-20250307-215506/output_info.log'
draw_sub_fig(ax5, title='$\mathrm{(e)}$ $\mathrm{Step=50}$的后续训练收益', file_path=path, i=index)
index += 1
# 右边下面的第二个图
ax6 = fig.add_subplot(gs[3, 1])
path = r'../log_res/ablation2/4-1/critic0/imitation_learning_env-100-20250307-213910/output_info.log'

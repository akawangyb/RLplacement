...
path = [r'../log_res/ablation/3exp2_critic/critic_loss.log',
        r'../log_res/ablation/3exp2_critic']
...
path = r'../log_res/ablation/3exp2_critic/imitation_learning_env-20250221-101055/output_info.log'
draw_sub_fig(ax3, title='$\mathrm{(c)}$ $\mathrm{Step=0}$的后续训练收益', file_path=path, i=index)
index += 1
# 右边上面的第二个图
ax4 = fig.add_subplot(gs[1, 1])
path = r'../log_res/ablation/3exp2_critic/imitation_learning_env-20250221-102746/output_info.log'
draw_sub_fig(ax4, title='$\mathrm{(d)}$ $\mathrm{Step=30}$的后续训练收益', file_path=path, i=index)
index += 1
# 右边下面的第一个图
ax5 = fig.add_subplot(gs[2, 1])
path = r'../log_res/ablation/3exp2_critic/imitation_learning_env-20250221-104446/output_info.log'
draw_sub_fig(ax5, title='$\mathrm{(e)}$ $\mathrm{Step=60}$的后续训练收益', file_path=path, i=index)
index += 1
# 右边下面的第二个图
ax6 = fig.add_subplot(gs[3, 1])
path = r'../log_res/ablation/3exp2_critic/imitation_learning_env-20250221-110205/output_info.log'
